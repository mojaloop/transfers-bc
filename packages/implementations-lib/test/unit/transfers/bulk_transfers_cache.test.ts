...
import { BulkTransfersCache } from "../../../src/transfers/bulk_transfers_cache"

describe("Implementations - Mongo Bulk Transfers Cache Unit Tests", () => {
	let cache: any;

	beforeEach(() => {
		cache = new BulkTransfersCache();
	});

...
export const TransferErrorCodes = {
    ...
    UNABLE_TO_VALIDATE_TRANSFER_FULFILMENT: "Unable to validate transfer fulfilment",
} as const;
...
export const TransferErrorCodeNames: {
    ...
    UNABLE_TO_VALIDATE_TRANSFER_FULFILMENT: "UNABLE_TO_VALIDATE_TRANSFER_FULFILMENT"
  };